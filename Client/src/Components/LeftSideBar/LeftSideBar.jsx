...
function LeftSideBar() {
  ...
  return (
    ...
    variants={containerVariants}>
        ...
        <a href={Language ? "https://drive.google.com/file/d/1eMqnapKiCcFfB8b3G82wiNqz7DZ5GfT9/view?usp=drive_link": "https://drive.google.com/file/d/1PNW8r01XffEU1pwLM29cMqWOr5kihorB/view?usp=drive_link"} target="_blank" rel="noopener noreferrer"><img src={Dark ? LogoCVDark : LogoCVLight} alt="" className={styles.socials}></img></a>
    </motion.div>
  );
}
