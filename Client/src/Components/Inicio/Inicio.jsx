    ...
    <div id="seccion-inicio" className={Dark ? styles.containerDark : styles.containerLight}>
        ...
        variants={containerVariants}>
            ...
            <p className={Dark ? styles.textDark : styles.textLigth}>{Language ?
             ...
             <a className={styles.fancy} href={Language ?  "https://drive.google.com/file/d/15k2PLpJ0Y3O10rS34zTWfgXrSnavCoox/view?usp=drive_link" : "https://drive.google.com/file/d/1Z3JQchdwrAA6zbp6WVN1IruF-ND18jC6/view?usp=drive_link"} target="_blank" rel="noopener noreferrer">
